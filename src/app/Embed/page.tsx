...
export default function Embed() {
      ...
      const defaultQuote = { text: "It is only when we take chances, when our lives improve. The initial and the most difficult risk that we need to take is to become honest", author: "~Walter Anderson" };
